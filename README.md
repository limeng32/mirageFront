...
test是由[generator-bee](https://github.com/kissyteam/generator-bee)生成。
...
会编译文件到build目录，同时会起一个本地server，访问：[http://localhost:5555/test/index.js](http://localhost:5555/test/index.js)，就是访问test/src/index.js文件。
